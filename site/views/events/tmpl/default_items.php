	...
	<table class="table table-hover gbjfamily_table<?php echo $pageclass_sfx; ?>" id="recordList">
		...
		<thead>
			<tr>
				...
				<?php echo JLayoutHelper::render('grid.headers', $this, $layoutBasePath, array('fields'=>'duration, turn')); ?>
				<?php echo JLayoutHelper::render('grid.headers', $this, $layoutBasePath, array('fields'=>'id_activity')); ?>
				<?php echo JLayoutHelper::render('grid.headers', $this, $layoutBasePath, array('fields'=>'id_stage')); ?>
		...
		<?php foreach ($this->items as $this->item->sequence => $this->item) : ?>
			...
			<tr <?php echo ($this->item->featured ? $this->htmlAttribute('class', $featuredClass) : ''); ?>>
				...
				<?php echo JLayoutHelper::render('grid.items', $this, $layoutBasePath, array('fields'=>'duration, turn')); ?>
				<?php echo JLayoutHelper::render('grid.items', $this, $layoutBasePath, array('fields'=>'id_activity')); ?>
				<?php echo JLayoutHelper::render('grid.items', $this, $layoutBasePath, array('fields'=>'id_stage')); ?>
