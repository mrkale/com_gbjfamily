...
<form action="<?php echo JRoute::_(
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid form-horizontal-desktop">
			...
			<?php echo $this->form->renderField('price_month'); ?>
			<?php echo $this->form->renderField('iban'); ?>
			<?php echo $this->form->renderField('varsymb'); ?>
			<?php echo $this->form->renderField('specsymb'); ?>
			<?php echo $this->form->renderField('billspan'); ?>
			<?php echo $this->form->renderField('payspan'); ?>
			<?php echo $this->form->renderField('id_domain'); ?>
			<?php echo $this->form->renderField('id_vendor'); ?>
			<?php echo $this->form->renderField('id_payform'); ?>
