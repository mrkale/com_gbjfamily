	...
	<table class="table table-striped" id="recordList">
		...
		<thead>
			<tr>
				...
				<?php echo JLayoutHelper::render('grid.headers', $this, $layoutBasePath, array('fields'=>'tacho')); ?>
				<?php echo JLayoutHelper::render('grid.headers', $this, $layoutBasePath, array('fields'=>'period')); ?>
				<?php echo JLayoutHelper::render('grid.headers', $this, $layoutBasePath, array('fields'=>'distance')); ?>
				<?php echo JLayoutHelper::render('grid.headers', $this, $layoutBasePath, array('fields'=>'consumption')); ?>
	...
	<?php endif; ?>
		...
		<?php foreach ($this->items as $this->item->sequence => $this->item): ?>
			<tr class="row<?php echo $this->item->sequence % 2; ?>">
				...
				<?php echo JLayoutHelper::render('grid.items_nodesc', $this, $layoutBasePath, array('fields'=>'quantity')); ?>
